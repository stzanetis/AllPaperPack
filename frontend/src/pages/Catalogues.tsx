    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        {catalogues.map((catalogue) => (
          <Card key={catalogue.id} className="rounded-3xl hover:shadow-md transition-full duration-200 hover:scale-105 flex flex-col"
            style={{
          ...
          >
            <CardHeader className="text-center">
              <CardTitle className="text-2xl font-tinos">{catalogue.title}</CardTitle>
